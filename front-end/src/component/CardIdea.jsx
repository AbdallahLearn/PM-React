        ...
        <>
            {items
                ...
                .map((item) => (
                    <div
                        key={item.id}
                        className={`card w-96 shadow-xl ${item.state === "accepted" ? "bg-green-500" : item.state === "edited" ? "bg-blue-700" : "bg-gray-400"} max-md:w-80 max-sm:w-80 m-auto`}
                    >
                        <div className="card-body">
                            ...
                            <div className="card-actions justify-evenly pt-16">
                                {editingId === item.id ? (
                                    ...
                                    <button 
                                        className="btn bg-white text-black hover:bg-white hover:text-green-700"
                                ...
                                <button
                                    className="btn bg-white text-black hover:bg-white hover:text-red-700"
                                    onClick={() => {
